            ...
            <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
                ...
                @php
                    $menuItems = [
                        ...
                        ['url' => '/portofolio', 'label' => 'Portofolio', 'pattern' => 'portofolio', 'icon' => '<rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path>', 'role' => 'jobseeker'],
                        ...
                        ['url' => '/lowongan', 'label' => 'Lowongan Kerja', 'pattern' => 'lowongan', 'icon' => '<rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"></path>'],
                        ['url' => '/sertifikat', 'label' => 'Sertifikat Saya', 'pattern' => 'sertifikat', 'icon' => '<path d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/>'],
                        ...
                        ['url' => '/streak',     'label' => 'Career Streak', 'pattern' => 'streak', 'icon' => '<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"></path><path d="M12 6v6l4 2"></path>'],
